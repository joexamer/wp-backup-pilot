...
class BPILOT_Settings {
	const OPTION = 'bpilot_settings';
	...
	public static function save( array $data ) {
		$profiles = array_keys( ( new BPILOT_Backup_Manager() )->profiles() );
		...
		update_option(
			...
			array(
				...
				'remote_prefix'       => trim( sanitize_text_field( $data['remote_prefix'] ?? 'backup-pilot' ), '/' ),
