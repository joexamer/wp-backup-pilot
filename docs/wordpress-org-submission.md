...
WP Backup Pilot should be submitted to WordPress.org after the GitHub-first public release proves the documentation, support flow, tests, and screenshots are ready.
